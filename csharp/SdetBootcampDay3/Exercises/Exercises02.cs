...
namespace SdetBootcampDay3.Exercises
{
    ...
    public class Exercises02
    {
         ...
         */
         [Test, TestCaseSource("NameData")]
         public async Task CheckNameOfUser(int userID, string name)
         {
         ...
         private static IEnumerable<TestCaseData> NameData()
         {
            ...
            yield return new TestCaseData(4, "Patricia Lebsack");
         }
/*
        [Test]
